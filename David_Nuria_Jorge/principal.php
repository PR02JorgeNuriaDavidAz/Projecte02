					...
					<div class="panel-body">
						<form>
							<?php
								...
								echo "<form name='formulario' method='POST' action='principal.php' accept-charset='UTF-8'>";
								...
								//SUBMIT
								echo "<input type='submit' value='Enviar' id='btnsubmit'><br>";
						...
						if(mysqli_num_rows($resultados)>0){
							...
							while($reserva = mysqli_fetch_array($resultados)){
								...
								echo "<form action='principal.php' method='REQUEST'>";
									echo "<tr class='filas'>";
									// echo "<tr class='filas' class='modalRecurso' data-toggle='modal' data-target='#myModal' onclick='openModal($reserva[idRecurso])'>";
										//echo "<td>$reserva[nombreRecursos]</td>";
										echo "<td>$reserva[nombreRecursos]</td>";
										echo "<td>$reserva[tipoRecursos]</td>";
		          		...
		          		<?php
							...
							while ($serveis = mysqli_fetch_array($consulta)) {
								...
								echo "<tr class='modalRecurso' data-toggle='modal' data-target='#myModal' onclick='openModal($serveis[idRecurso])'>";
									...
									echo "<td>$serveis[nombreRecursos]</td>";
									echo "<td>$serveis[tipoRecursos]</td>";							
								echo "</tr>";						
							}

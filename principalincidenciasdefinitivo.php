			...
			<div class="col-lg-12">
				<div class="panel-group">
					<div class="panel panel-primary">
						...
						<div class="panel-body"> 
<!--A PARTIR DE AQUÍ COMIENZA EL FORM DE INCIDENCIAS -->
							<form  action='principal.php' method='REQUEST' accept-charset='UTF-8'>
								<?php
									error_reporting(0);
									session_start();
...
<!--AQUÍ ACABA EL FORM DE INCIDENCIAS -->
...
//CODIGO PHP INCIDENCIAS COMIENZA AQUÍ
...
//CODIGO PHP INCIDENCIAS ACABA AQUÍ

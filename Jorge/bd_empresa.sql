...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 14-11-2017 a las 15:29:31
...
CREATE TABLE `tbl_recurso` (
  ...
  `fotoRecursos` varchar(25) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `tbl_recurso` (`idRecurso`, `nombreRecursos`, `tipoRecursos`, `Ocupado`, `fotoRecursos`) VALUES
(1, 'Aula teoría con projector 01', 'Sala', 1, 'aula.jpg'),
(2, 'Aula teoría con projector 02', 'Sala', 1, 'aula2.jpg'),
(3, 'Aula teoría sin projector', 'Sala', 1, 'aula3.png'),
